...
func sendB2CPayment(phone string, amount string) (map[string]interface{}, error) {
	...
	payload := B2CRequest{
		...
		PartyB:             phone,
		Remarks:            "B2C Payment",
		QueueTimeOutURL:    "https://webhook.site/389ef100-b115-4af9-a749-6168b3735790",
		ResultURL:          "https://webhook.site/389ef100-b115-4af9-a749-6168b3735790",
		Occasion:           "Withdrawal",
	}
...
const (
	...
	initiatorName      = "Joyce"
	securityCredential = ""
	shortCode          = "3008816"
