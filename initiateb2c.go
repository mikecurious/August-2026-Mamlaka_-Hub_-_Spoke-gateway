...
func sendB2CPayment(phone string, amount string) (map[string]interface{}, error) {
	...
	payload := B2CRequest{
		...
		PartyB:             phone,
		Remarks:            "B2C Payment",
		QueueTimeOutURL:    "https://webhook.site/363a9211-a4e2-421c-9cdd-783fe5e1a895",
		ResultURL:          "https://webhook.site/363a9211-a4e2-421c-9cdd-783fe5e1a895",
		Occasion:           "Withdrawal",
	}
...
func main101() {
	...
	resp, err := sendB2CPayment("254741369908", "10")
	if err != nil {
